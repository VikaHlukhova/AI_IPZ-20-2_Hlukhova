...
plt.title('Границі моделі класифікатора на основі К ближніх сусідів')
...
plt.scatter(test_datapoint[0], test_datapoint[1], marker='x', linewidths=6, s=200, facecolor='black')
